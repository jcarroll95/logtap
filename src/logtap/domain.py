"""
The domain.py module contains dataclass definitions for the LogLine, ParseStats, and Report objects used throughout the
...
parsed log data for reporting purposes. These objects have been moved out of models.py to better separate ORM, DTO, and
